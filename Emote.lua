...
function OnEmotePlay(EmoteName)
  ...
  if inVehicle == 1 then --Tähän muokattu abuset
    TriggerEvent('chat:addMessage', {
      color = { 255, 0, 0},
      multiline = true,
      args = {"Palvelin:", "Älähän Yritä abusea!"}
    })
    return false
  end

  if not DoesEntityExist(playerPed) or IsEntityInAir(playerPed) then --Tähän muokattu abuset
    TriggerEvent('chat:addMessage', {
      color = { 255, 0, 0},
      multiline = true,
      args = {"Palvelin:", "Älähän Yritä abusea!"}
